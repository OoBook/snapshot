...
/**
 * HasMany relation that proxies through the snapshot's source model.
 * The related model has a foreign key pointing to the source.
 */
class SnapshotSyncedHasMany extends HasMany
{
    ...
    public function getResults(): mixed
    {
        ...
        return $this->query->where($this->foreignKey, $sourceId)->get();
    }
